...
using (StreamWriter escrever = new StreamWriter(temp + ".txt"))
{
    ...
    Console.WriteLine($"                 ------{DateTime.Now}-----Sessão iniciada ");
    int saldo = 0;
        ...
        while (retorno)
        {
            switch (conta)
            {
                case 1:
                    ...
                    if (int.TryParse(Console.ReadLine(), out int tipoTransacao))
                        switch (tipoTransacao)
                        {
                            ...
                            case 3:
                                escrever.WriteLine($"Transferência ");
                ...
                case 4:
                    ...
                    escrever.WriteLine($"Saindo do caixa eletrônico, retire seu cartão ");
                    return;
                    break;
                default:
                    break;
